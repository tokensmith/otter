...
/**
 * This is an example of how a rest resource can use sessions for auth.
 *
 * See AppConfig for how it's RestTarget is configured.
 */
public class HelloSessionRestResource extends RestResource<ApiUser, Hello> {
    public static String URL = "/rest/v2/session/hello";
