...
public class RequestBuilderTest {
    private RequestBuilder<DummySession, DummyUser, EmptyPayload> subject;

    @Before
    public void setUp() {
        subject = new RequestBuilder<DummySession, DummyUser, EmptyPayload>();
    }

    @Test
    public void buildWhenMatcherShouldBeOk() {
        Request<DummySession, DummyUser, EmptyPayload> actual = subject.matcher(Optional.empty()).build();
    ...
    public void buildWhenPathWithParamsShouldBeOk() {
        ...
        Request<DummySession, DummyUser, EmptyPayload> actual = subject.pathWithParams(url).build();
    ...
    public void buildWhenMethodShouldBeOk() {
        Request<DummySession, DummyUser, EmptyPayload> actual = subject.method(Method.GET).build();
    ...
    public void buildWhenContentTypeShouldBeOk() {
        ...
        Request<DummySession, DummyUser, EmptyPayload> actual = subject.contentType(contentType).build();
    ...
    public void buildWhenHeadersShouldBeOk() {
        ...
        Request<DummySession, DummyUser, EmptyPayload> actual = subject.headers(headers).build();
    ...
    public void buildWhenCookiesShouldBeOk() {
        ...
        Request<DummySession, DummyUser, EmptyPayload> actual = subject.cookies(cookies).build();
    ...
    public void buildWhenQueryParamsShouldBeOk() {
        ...
        Request<DummySession, DummyUser, EmptyPayload> actual = subject.queryParams(queryParams).build();
    ...
    public void buildWhenFormDataShouldBeOk() {
        ...
        Request<DummySession, DummyUser, EmptyPayload> actual = subject.formData(formData).build();
    ...
    public void buildWhenPayloadShouldBeOk() {
        ...
        Request<DummySession, DummyUser, EmptyPayload> actual = subject.body(json).build();
    ...
    public void buildWhenIpAddressShouldBeOk() {
        ...
        Request<DummySession, DummyUser, EmptyPayload> actual = subject.ipAddress(ipAddress).build();
