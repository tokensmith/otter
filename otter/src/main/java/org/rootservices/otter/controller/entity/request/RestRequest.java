package org.rootservices.otter.controller.entity.request;
...
public class RestRequest<U, P> {
    ...
    public RestRequest(Optional<Matcher> matcher, Method method, String pathWithParams, MimeType contentType, Map<String, String> headers, Map<String, Cookie> cookies, Map<String, List<String>> queryParams, Map<String, List<String>> formData, Optional<byte[]> body, String ipAddress, Optional<P> payload) {
