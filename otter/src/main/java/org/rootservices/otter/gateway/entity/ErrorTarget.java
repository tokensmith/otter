...
public class ErrorTarget<S extends DefaultSession, U extends DefaultUser, P extends Translatable> {
    private Resource<S, U, P> resource;
    private List<Between<S, U, P>> before;
    private List<Between<S, U, P>> after;

    public ErrorTarget(Resource<S, U, P> resource, List<Between<S, U, P>> before, List<Between<S, U, P>> after) {
