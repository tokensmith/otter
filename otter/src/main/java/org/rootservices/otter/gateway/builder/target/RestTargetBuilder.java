...
public class RestTargetBuilder<S extends DefaultSession, U extends DefaultUser, P extends Translatable> {
    ...
    public RestTargetBuilder<S, U, P> resource(Resource<S, U, P> resource) {
    ...
    public RestTargetBuilder<S, U, P> label(Label label) {
        this.labels.add(label);
        return this;
    }

    public RestTargetBuilder<S, U, P> before(Between<S, U, P> before) {
        this.before.add(before);
        return this;
    }

    public RestTargetBuilder<S, U, P> after(Between<S, U, P> after) {
        this.after.add(after);
        return this;
    }

    public RestTargetBuilder<S, U, P> errorTarget(StatusCode statusCode, ErrorTarget<S, U, P> errorTarget) {
    ...
    public RestTarget<S, U, P> build() {
        return new RestTarget<S, U, P>(methods, regex, resource, contentTypes, payload, labels, before, after, errorTargets, groupName);
    }
}
